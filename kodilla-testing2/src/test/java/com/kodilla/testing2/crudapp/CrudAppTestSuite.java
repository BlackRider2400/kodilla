...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://blackrider2400.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException{
        ...
        driverTrello.findElement(By.id("user")).sendKeys("krzysztofbaralkiewicz@gmail.com");		        // [3]
        driverTrello.findElement(By.id("password")).sendKeys("Skibowa14");		    // [4]
        WebElement el = driverTrello.findElement(By.id("login"));
        el.submit();									                                // [5]

        Thread.sleep(4000);								                            // [6]

        driverTrello.findElement(By.id("password")).sendKeys("Skibowa14");		    // [7]
    ...
    private void clearTaskListAfterTest(String taskName) throws InterruptedException{
        driver.navigate().refresh();                                         // [1]
        ...
        driver.findElements(
                ...
                .forEach(theForm -> {
                            WebElement buttonDelete = theForm.findElement(By.xpath(".//fieldset[contains(@class, \"datatable__row-section datatable__row-section--button-section\")]/button[4]"));
                            buttonDelete.click();
                        }
                );// [6]
    ...
    public void shouldCreateTrelloCard() throws InterruptedException {
        ...
        clearTaskListAfterTest(taskName);
    }
}
